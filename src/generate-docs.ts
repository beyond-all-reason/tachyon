...
export async function generateDocs(
    ...
    let schemaIndex = autoGeneratedPrefix;
    schemaIndex += "# Schema\n\n";
    for (const serviceId in tachyonSchema) {
        schemaIndex += `- [${serviceId}](${serviceId}.md)\n`;
    }

    await fs.promises.rm("docs/schema", { recursive: true, force: true });
    await fs.promises.mkdir("docs/schema", { recursive: true });
    await fs.promises.writeFile("docs/schema/README.md", schemaIndex);
